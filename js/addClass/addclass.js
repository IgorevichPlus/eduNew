...
function createClass() {
  var title = document.getElementById("class_title").value;
  var description = document.getElementById("class_description").value;

  function writeClass(title, description);
